...
export class DatabaseService {
  ...
  private static USE_DATABASE = process.env.NODE_ENV === "production" && process.env.DATABASE_URL
  ...
  static async testConnection(): Promise<boolean> {
    ...
    try {
      ...
      console.error("Database connection failed, falling back to memory:", error)
      return false
    }
  }
