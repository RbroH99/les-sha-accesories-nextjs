        ...
        <div className="max-w-2xl mx-auto">
          <Card className="text-center">
            <CardHeader className="pb-8">
              ...
              <CardTitle className="text-3xl font-bold text-gray-900 mb-4">¡Pedido Confirmado!</CardTitle>
                ...
                <div className="space-y-4 text-left">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Comenzaremos a preparar tu pedido con el cuidado y atención que merece.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Te notificaremos cuando tu pedido esté en camino con información de seguimiento.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="flex items-center space-x-3 p-4 bg-blue-50 rounded-lg">
                  ...
                  <div className="text-left">
                    <p className="font-medium text-gray-900">Email de confirmación</p>
